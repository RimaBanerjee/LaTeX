...
%	level 2/.style={level distance=3cm, sibling angle=45}] %here we create level 2 because each child hast different children. % select angle as your convaniant
 \node{Latex} %main node
	...
	child { node {Beginner}[concept color=blue!40]
	...
	child { node {Thesis}[concept color=red!40]
	...
	child { node {Beamer Series}[concept color=yellow!40]
    ...
    child { node {Tikz Series}[concept color=pink!40]
